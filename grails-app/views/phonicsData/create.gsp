...
<body>
<a href="#create-phonicsData" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="create-phonicsData" class="content scaffold-create" role="main">
    <h1><g:message code="default.create.label" args="[entityName]" /> ${phonicsData?.typeFile?.value}</h1>
    ...
    <g:form resource="${this.phonicsData}" method="POST" enctype="multipart/form-data">
        <fieldset class="form">
            ...
            <g:if test="${phonicsData?.typeFile.ke!=TypeKeyValue.fileTypeImage}">
                <div class='fieldcontain required'>
                    <label for='dateFile'>
                        ${phonicsData?.typeFile?.value}<span class='required-indicator'>*</span>
                    </label>
            ...
            <div hidden>
                ...
                <f:field bean="phonicsData" property="scan" value="0"/>
                <f:field bean="phonicsData" property="typeDate"  value="${study.TypeKeyValue.findByTypeAndKe(TypeKeyValue.menuType,TypeKeyValue.menuTypePhonics)}" />
